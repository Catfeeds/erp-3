...
$configs= array(
        ...
        'MODULE_ALLOW_LIST'  => array(
            'Admin','Portal','Asset','Api','User','Wx','Comment',
            'Tpl','Topic','Install','Bug','Better','Pay','Cas',
            'Public','Department','Category','Product','Order','Domain','Warehouse',
            'Settlement','Purchase','Report','Message','Advert','Log','Shipping','Supplier','Systemrecord',
            'Mailqueue','Sms','Payment','Goodslocation','Waybill','Checkcategory','Oms'
        ),
        ...
        //嘉里 物流接口配置信息 kerrytj
        'KERRYTJ_API_CONFIG'=> array(
            'REQUEST_URL' => 'http://api.kerrytj.com/ked/api/RequestShipment.ashx',//http://adm.kerrytj.com/ked/api/RequestShipment.ashx  api正式地址
            'KEY' => '60ec4eb7f91d4c1795b793f47573a98c',//78d2c66257dc48c8a78306f0e5287aab
            'CUSTOMER_NO' => '22220123',
            'SPECIAL_CUSTOMER_NO' => '22220131',//特货 用户
            'ERP_UPDATE_STATUS' => '91bde0b2e9298f55a10a8997bf6b3037',//回传 运单状态信息key值
        ),

        'KERRYTJ_CHECK_AREA_API_CONFIG' => array(
            'REQUEST_URL' => 'http://api.kerrytj.com/ked/api/ExistUnassignedArea.ashx',//http://adm.kerrytj.com/ked/api/RequestShipment.ashx  api正式地址
            'KEY' => '51fcc8539158487db4f4d374ae6f76cf',//51fcc8539158487db4f4d374ae6f76cf
        )
);
