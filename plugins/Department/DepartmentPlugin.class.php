...
// +----------------------------------------------------------------------
namespace plugins\Department;//Comment插件英文名，改成你的插件英文就行了
use Common\Lib\Plugin;

/**
 * Comment
 */
class DepartmentPlugin extends Plugin{//Comment插件英文名，改成你的插件英文就行了

        public $info = array(
            'name'=>'Department',//Comment插件英文名，改成你的插件英文就行了
            'title'=>'部门',
            'description'=>'部门插件',
            'status'=>1,
            'author'=>'Morro',
